...
for x = 1:length(X)
 ...
 MrIPA = 60.1;
                    ...
                    Massflow_wat = mass_basis - Massflow_Mea - Massflow_Ox-Massflow_PG; %OR MASS FLOW PG
                    ...
                    DelhrPG = 1908*1000/MrPG; %KJ/kg
                    DelhrPG = 1800*1000/MrPG; %Kj/kg
...
savefig(1,'wt_vs_T2_MEA_PG_steam')
savefig(2,'wt_vs_poweroutwat_MEA_PG_steam')
savefig(3,'wt_vs_powerout_MEA_PG_steam')
savefig(4,'wt_vs_restime_MEA_PG_steam')
save('wt_MEA_PG_steam')