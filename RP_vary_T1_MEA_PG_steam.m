    ...
    for P1 = 1:length(T1)
        ...
        Dens = Vmat(2);
            ...
            %% start wt iteration
                    ...
                    Massflow_wat = mass_basis - Massflow_Mea - Massflow_Ox- Massflow_PG;
...
savefig(1,'T1_vs_T2_MEA_PG_steam')
savefig(2,'T1_vs_poweroutwat_MEA_PG_steam')
savefig(3,'T1_vs_powerout_MEA_PG_steam')
savefig(4,'T1_vs_restime_MEA_PG_steam')
save('T1_MEA_PG_steam')