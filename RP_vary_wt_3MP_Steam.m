    ...
    for P1 = 1:length(wt)
        ...
        Dens = Vmat(2);
            ...
            %% start wt iteration
                    ...
                    Massflow_wat = mass_basis - Massflow_3MP - Massflow_Ox;
...
savefig(1,'wt_vs_T2_3MP_steam')
savefig(2,'wt_vs_poweroutwat_3MP_steam')
savefig(3,'wt_vs_powerout_3MP_steam')
savefig(4,'wt_vs_restime_3MP_steam')
save('wt_3MP_steam')