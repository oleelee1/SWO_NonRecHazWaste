    ...
    for P1 = 1:length(wt)
        ...
        Dens = Vmat(2);
            ...
            %% start wt iteration
                    ...
                    Massflow_wat = mass_basis - Massflow_Mea - Massflow_Ox-Massflow_IPA; %OR MASS FLOW PG
...
savefig(1,'wt_vs_T2_MEA_IPA_steam')
savefig(2,'wt_vs_poweroutwat_MEA_IPA_steam')
savefig(3,'wt_vs_powerout_MEA_IPA_steam')
savefig(4,'wt_vs_restime_MEA_IPA_steam')
save('wt_MEA_IPA_steam')